...
public class MyTeamAdapter extends ArrayAdapter<MyTeam> {

    private int resourceId;
    public MyTeamAdapter(Context context, int textViewResourceId,
                        List<MyTeam> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView MyTeamImage=(ImageView) view.findViewById(R.id.MT_img);
        TextView MyTeamName=(TextView) view.findViewById(R.id.MT_name);
