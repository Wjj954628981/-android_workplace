...
public class MyTeamNewsAdapter extends ArrayAdapter<MyTeam> {

    private int resourceId;
    public MyTeamNewsAdapter(Context context, int textViewResourceId,
                         List<MyTeam> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView MyTeamImage=(ImageView) view.findViewById(R.id.MT2_img);
        TextView MyTeamName=(TextView) view.findViewById(R.id.MT2_name);
