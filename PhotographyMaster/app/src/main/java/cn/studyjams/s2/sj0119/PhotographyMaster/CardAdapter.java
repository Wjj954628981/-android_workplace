...
public class CardAdapter extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    private List<PhotoInfo> mData; //定义数据源

    //定义构造方法，默认传入上下文和数据源
    public CardAdapter(Context context, List<PhotoInfo> data) {
        mContext = context;
        mData = data;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        PhotoInfo newsinfo = mData.get(position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            NewsImg = (ImageView) itemView.findViewById(R.id.ShowImg);
            NewsTitle = (TextView) itemView.findViewById(R.id.ShowTitle);
        }
    }
